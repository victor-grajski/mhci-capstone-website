        ...
        <div id="domain-research" className="article-content domain-research wf-section">
            ...
            <div className="one-two w-row">
                ...
                <p className="section-intro-text">
                    <a href="https://www.assurant.com/newsroom-detail/Features/2018/February/c.a.s.e.-the-acronym-taking-over-the-auto-industry" target="_blank" className="article-link">CASE</a> is the current megatrend unfolding in the automotive industry. That is, under current trends, the car of the future will be Connected, Autonomous Shared, and Electric.<br />
                </p>
                </div>
                <div className="w-col w-col-2 w-col-stack"></div>
            ...
            <div className="columns-8 w-row">
                <div className="w-col w-col-1 w-col-stack"></div>
                <div className="column-15 w-col w-col-4 w-col-stack">
                <p className="section-intro-text">In our hyper-connected world, our everyday experience is constrained by the <a href="https://econreview.berkeley.edu/paying-attention-the-attention-economy/" target="_blank" className="article-link">attention economy</a>.</p>
                </div>
                <div className="w-col w-col-2 w-col-stack"></div>
            ...
            <div className="columns-8 w-row">
                <div className="w-col w-col-1 w-col-stack"></div>
                <div className="column-15 w-col w-col-4 w-col-stack">
                <p className="section-intro-text">In a recent <a href="https://www.zipcar.com/press/releases/third-annual-millennial-study" target="_blank" className="article-link">survey</a> by ZipCar, nearly half of Millennials said they sometimes choose to spend time with friends online instead of driving to see them in person. </p>
                </div>
                <div className="w-col w-col-2 w-col-stack"></div>
            ...
            <div className="columns-8 w-row">
                <div className="w-col w-col-1 w-col-stack"></div>
                <div className="column-15 w-col w-col-4 w-col-stack">
                <p className="section-intro-text">In 2020, the car made a <a href="https://www.nny360.com/communitynews/business/cars-are-making-a-comeback-thanks-to-covid/article_73172663-6d85-5eb9-b2e1-a89077819e48.html" target="_blank" className="article-link">comeback</a>. COVID made cars more <a href="https://www.theatlantic.com/health/archive/2020/08/millennials-are-buying-covid-cars/615325/" target="_blank" className="article-link">attractive</a> as they once again symbolized <a href="https://www.cars.com/articles/americans-revive-the-sunday-drive-and-use-their-cars-as-much-needed-escape-during-the-covid-19-pandemic-according-to-new-research-by-cars-com-420899/" target="_blank" className="article-link">freedom</a> and safety.</p>
                </div>
                <div className="w-col w-col-2 w-col-stack"></div>
