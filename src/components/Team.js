          ...
          <div class="columns-2 w-row">
              ...
              <div>
                <div class="div-block-19">
                  <div class="div-block-18">
                    <p class="paragraph-6">We&#x27;re a team of Human-Computer Interaction Master&#x27;s (MHCI) students at Carnegie Mellon University. We&#x27;re not just a team of researchers and designers, we&#x27;re a team of iconoclasts who refuse to accept a status quo where the car has been reduced to an appliance. While we may have tried to boil the ocean and failed, we did manage to get a few drops of wisdom, and we&#x27;re excited to share what we&#x27;ve learned with you!</p>
                  </div>
                </div>
            ...
            <div class="column-8 w-col w-col-3 w-col-stack">
              <div class="div-block-21">
                ...
                <div class="w-embed w-iframe"><iframe src="https://open.spotify.com/embed/playlist/49m5J6XQbayAjiodsrVtTu" width="100%" height="423" frameborder="0" allowtransparency="true" allow="encrypted-media" title="Road Trip Playlist"></iframe></div>
              </div>
            </div>
            <div class="w-col w-col-1 w-col-stack"></div>
          </div>
          ...
          <div class="columns-4 w-row">
            ...
            <div class="column-11 w-col w-col-3 w-col-stack w-col-small-small-stack">
              ...
              <div class="div-block-21">
                ...
                <div class="w-embed w-iframe"><iframe src="https://open.spotify.com/embed/track/6mw4IlMjJq52O8Qa48LuAW" width="100%" height="423" frameborder="0" allowtransparency="true" allow="encrypted-media" title="Cam's Road Trip Anthem"></iframe></div>
              </div>
            </div>
            <div class="w-col w-col-1 w-col-stack w-col-small-small-stack"></div>
          </div>
        ...
        <div class="section-3">
          <div class="columns-4 reverse w-row">
            ...
            <div class="column-11 w-col w-col-3 w-col-stack w-col-small-small-stack">
              ...
              <div class="div-block-21">
                <div>
                  <h3 class="heading-2">Jenny&#x27;s Road Trip Anthem</h3>
                </div>
                <div class="w-embed w-iframe"><iframe src="https://open.spotify.com/embed/track/2PSeBKFabj27ud497FxQQy" width="100%" height="423" frameborder="0" allowtransparency="true" allow="encrypted-media" title="Jenny's Road Trip Anthem"></iframe></div>
              </div>
            </div>
            <div class="w-col w-col-1 w-col-stack w-col-small-small-stack"></div>
          </div>
        ...
        <div class="section-3">
          <div class="columns-4 w-row">
            ...
            <div class="column-11 w-col w-col-3 w-col-stack w-col-small-small-stack">
              ...
              <div class="div-block-21">
                <div>
                  <h3 class="heading-2">Lauren&#x27;s Road Trip Anthem</h3>
                </div>
                <div class="w-embed w-iframe"><iframe src="https://open.spotify.com/embed/track/0lkQOB949M2gLyut86aJ1b" width="100%" height="423" frameborder="0" allowtransparency="true" allow="encrypted-media" title="Lauren's Road Trip Anthem"></iframe></div>
              </div>
            </div>
            <div class="w-col w-col-1 w-col-stack w-col-small-small-stack"></div>
          </div>
        ...
        <div class="section-3">
          <div class="columns-4 reverse w-row">
            ...
            <div class="column-11 w-col w-col-3 w-col-stack w-col-small-small-stack">
              ...
              <div class="div-block-21">
                <div>
                  <h3 class="heading-2">Sarah&#x27;s Road Trip Anthem</h3>
                </div>
                <div class="w-embed w-iframe"><iframe src="https://open.spotify.com/embed/track/39q7xibBdRboeMKUbZEB6g" width="100%" height="423" frameborder="0" allowtransparency="true" allow="encrypted-media" title="Sarah's Road Trip Anthem"></iframe></div>
              </div>
            </div>
            <div class="w-col w-col-1 w-col-stack w-col-small-small-stack"></div>
          </div>
        ...
        <div class="section-3">
          <div class="columns-4 w-row">
            ...
            <div class="column-11 w-col w-col-3 w-col-stack w-col-small-small-stack">
              ...
              <div class="div-block-21">
                <div>
                  <h3 class="heading-2">Victor&#x27;s Road Trip Anthem</h3>
                </div>
                <div class="w-embed w-iframe"><iframe src="https://open.spotify.com/embed/track/0t6DAi9KEiaWOtgTTXGhD2" width="100%" height="423" frameborder="0" allowtransparency="true" allow="encrypted-media" title="Victor's Road Trip Anthem"></iframe></div>
              </div>
            </div>
            <div class="w-col w-col-1 w-col-stack w-col-small-small-stack"></div>
          </div>
